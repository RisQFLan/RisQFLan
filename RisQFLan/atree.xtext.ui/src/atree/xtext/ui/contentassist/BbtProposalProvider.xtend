 ...
 */
package atree.xtext.ui.contentassist
 ...
 */
class BbtProposalProvider extends AbstractBbtProposalProvider {
	
//	override complete_FORMATS(EObject model, RuleCall ruleCall, ContentAssistContext context, ICompletionProposalAcceptor acceptor) {
//		acceptor.accept(createCompletionProposal('PRISM', context))
//		acceptor.accept(createCompletionProposal('STORM', context))
//	}
	...
	override completeAnalysis_LogFile(EObject model, Assignment assignment, ContentAssistContext context, ICompletionProposalAcceptor acceptor) {
		acceptor.accept(pickAFilePrivate(context,"Pick a file..."));
		super.completeAnalysis_LogFile(model, assignment, context, acceptor)
	}
