package atree.xtext.ui.perspective.plot;
...
import atree.core.simulation.output.DataOutputHandlerAbstract;
//import atree.xtext.ui.perspective.plot.PlotView;
		...
		Display.getDefault().syncExec(new Runnable() {
			...
			public void run() {
				...
				try {
					...
					if(hasSMCVariances){
						plotViewSMCVariances = (PlotView) PlatformUI.getWorkbench().getActiveWorkbenchWindow().getActivePage().showView("atree.xtext.ui.perspective.plot.PlotView",consoleName+"SMCVar"+counter,org.eclipse.ui.IWorkbenchPage.VIEW_ACTIVATE);
					...
					plotViewMeans = (PlotView) PlatformUI.getWorkbench().getActiveWorkbenchWindow().getActivePage().showView("atree.xtext.ui.perspective.plot.PlotView",consoleName+counter,org.eclipse.ui.IWorkbenchPage.VIEW_ACTIVATE);
